...
const Features = () => {
  return (
    <section className='FeaturesContainer'>
      <h2 className='FeatureTitle'>FEATURES WITH MORE WONDERS</h2>
        ...
        <div className='RightContent'>
          <div className='WhiteContainer'>
            <div className='ImageContainer'>
              <img className='FeatureImage' src="/img/person7.png" alt="Feature" />
            </div>
            <div>
              ...
              <div className='ButtonContainer'>
                <a className='GetStartedButton' href="#trynow">TRY NOW</a>
