    ...
    <div className='MainContainer'>
      ...
      <section className='SectionContainer'>
        <div className='ImageContainer'>
          <img className='Image' src="/img/picture2.png" alt="Engaging content" />
        </div>
      </section>
    </div>
  );
